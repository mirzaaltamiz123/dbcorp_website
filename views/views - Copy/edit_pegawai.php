...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE employees SET nama = ?, departemen = ?, jabatan = ?, tanggal_bergabung = ?, status_kepegawaian = ? WHERE id = ?";
    $stmt = $conn->prepare($query);
    ...
    <div class="container mt-5">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tanggal_bergabung" name="tanggal_bergabung" value="<?= $data['tanggal_bergabung'] ?>" required>
            </div>
            <div class="mb-3">
